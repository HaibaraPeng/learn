package com.roc.registry.zk.util;

import com.roc.enums.RpcConfigEnum;
import com.roc.utils.PropertiesFileUtil;
    ...
    public void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                // eg: /my-rpc/com.roc.HelloService/127.0.0.1:9999
