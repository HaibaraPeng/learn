package com.roc.remoting.transport.netty.codec;

import com.roc.compress.Compress;
...
import com.roc.serialize.Serializer;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    public RpcMessageDecoder() {
        ...
        // lengthAdjustment: full length include all data and read 9 bytes before, so the left length
        // initialBytesToStrip:
     ...
     *                            If you only want to receive the body data, then you need to skip the number of bytes
    ...
    private Object decodeFrame(ByteBuf in) {
        ...
        if (messageType == RpcConstants.HEARBEAT_RESPONSE_TYPE) {
